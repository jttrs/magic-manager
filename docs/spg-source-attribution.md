# Special Guests (SPG) source attribution

How to map a Special Guests printing to its parent release. **Documented but not implemented as of V1.5.** This file captures the approach so future work can pick it up without rediscovering the audit.
