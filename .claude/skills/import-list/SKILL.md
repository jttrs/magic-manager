...
uv run mm list import set:fca inventory/final-fantasy-through-the-ages-master-2026-05-25.xlsx
...
User finishes filling in `inventory/final-fantasy-through-the-ages-master-2026-05-25.xlsx`:
> "I'm done filling in the FCA master list."

Steps:
1. `uv run mm list import set:fca inventory/final-fantasy-through-the-ages-master-2026-05-25.xlsx`
